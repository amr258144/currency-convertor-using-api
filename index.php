...
include('header.php');
?>
<title>Currency conversion in PHP Using API by AMR</title>
<script type="text/javascript" src="script/validation.min.js"></script>
<script type="text/javascript" src="script/ajax.js"></script>
<?php include('container.php');?>
<div class="container">
<marquee style="color:green;font-size:30px"> Latest Currency Rate (Date: <?php echo date('d-m-Y', time()); ?> | Day: <?php echo date('D', strtotime(date('d-m-Y'))); ?>)</marquee>
	<h2>Welcome to CCL Currency convertor in PHP Using API</h2>	
	<br />
	<br />
	<br />
	<form method="post" id="currency-form">
		...
		<label>From</label>
			<select name="from_currency" style="height:40px;width:200px">
			...
			&nbsp;
			<label>Amount</label>	
			<input type="text" placeholder="Currency" name="amount" id="amount" style="height:40px;width:200px" />			
			&nbsp;<label>To</label>
			<select name="to_currency" style="height:40px;width:200px">
				<option  value="USD">US Dollar ($)</option>
				<option  value="INR">Indian Rupee (₹)</option>
				<option  value="AED">United Arab Emirates Dirham (AED)</option>
				<option  value="AFN">Afghan Afghani (AFN)</option>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" value="1" name="convert" id="convert" class="btn btn-default" style="background:#3399ff;color:white">Convert</button>	
